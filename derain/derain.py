...
class Ui_DerainForm(object):
    def setupUi(self, DerainForm):
        ...
        self.pushButton_3 = QtWidgets.QPushButton(DerainForm)
        ...
        self.columnView_2 = QtWidgets.QColumnView(DerainForm)
        self.columnView_2.setObjectName("columnView_2")
        self.horizontalLayout_6.addWidget(self.columnView_2)
        self.columnView_3 = QtWidgets.QColumnView(DerainForm)
        self.columnView_3.setObjectName("columnView_3")
        self.horizontalLayout_6.addWidget(self.columnView_3)
    ...
    def retranslateUi(self, DerainForm):
        ...
        self.pushButton_3.setText(_translate("DerainForm", "打开文件"))
